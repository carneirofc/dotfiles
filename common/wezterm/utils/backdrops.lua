...
---
--- INFO:
---   During the initial load of the config, this function can only be invoked in `wezterm.lua`.
---   WezTerm's fs utility `glob` (used in this function) works by running on a spawned child process.
---   This throws a coroutine error if the function is invoked outside of `wezterm.lua` in the
...
---Select a random background from the loaded `images`
...
---Cycle the loaded `images` and select the next background
---@param window Window WezTerm `Window` see: https://wezfurlong.org/wezterm/config/lua/window/index.html
...
---Cycle the loaded `images` and select the previous background
---@param window Window WezTerm `Window` see: https://wezfurlong.org/wezterm/config/lua/window/index.html
...
---Set a specific background from the `images` array
---@param window Window WezTerm `Window` see: https://wezfurlong.org/wezterm/config/lua/window/index.html
